...
const HolesSelector = ({ holes, initialHoles = "18" }) => {
  const [selected, setSelected] = useState(initialHoles);
  ...
  return (
    ...
    >
      <button
        ...
        className={
          "w-1/3 h-full " +
          (selected == "18" && "border bg-golf/20 border-golf rounded-l-md")
        }
      >
        18
      </button>
